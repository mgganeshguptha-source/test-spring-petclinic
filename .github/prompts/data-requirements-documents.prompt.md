...
Generate interface documentation for microservice with below details. In case if you are not able to find particular information, mention "Not Available".
...
2. Interface type (the message type and protocol under which the interface is being exposed)
...
7. Describe main flow (in this way like Step 1: Description, Step 2: Description etc)
